...
(function () {
  ...
  L.fa = {
      ...
      ad_per_day: "در روز",
      ad_ready_in: "آماده در",
      we_gem_bonus: "پنجمین نمایش 💎 پاداش می‌دهد!",
      watch_earn_done: "هر ۵ تای امروز انجام شد ✓",
      ads_unavailable: "تبلیغ هنوز در دسترس نیست. بعداً سر بزن!",
      ad_sdk_missing: "SDK تبلیغ بارگذاری نشد. صفحه را تازه کن.",
      ...
      battle_chapter_complete: "✓ فصل تمام شد",
      ...
      guild_tier_lone: "جنگاور تنها",
      guild_tier_warband: "دسته‌ی جنگی",
      guild_tier_clan: "اتحادیه",
      guild_tier_council: "شورای جنگ",
      guild_tier_vanguard: "پیشتاز شاه",
      guild_role_leader: "⚔ رهبر اتحادیه",
      guild_role_member: "عضو",
      guild_btn_chat: "💬 گفتگوی اتحادیه",
      guild_btn_share: "📢 اشتراک‌گذاری اتحادیه",
      guild_btn_manage: "⚙ مدیریت",
      guild_btn_manage_close: "✖ بستن",
      guild_warriors_suffix: "{n} جنگاور",
      guild_share_text: "به اتحادیه‌ی من {name} در شاهنامه بپیوند! با هم ریال کسب می‌کنیم. ⚔️",
      guild_no_warriors: "هنوز جنگاوری نیست. لینک دعوتت را به اشتراک بگذار.",
      guild_lvl_xp: "سطح {lvl} · {xp} تجربه",
      guild_tag_leader: "رهبر",
      guild_tag_member: "⚔ عضو",
      guild_settings_title: "⚙ تنظیمات اتحادیه",
      guild_tg_link_label: "💬 لینک گروه تلگرام",
      guild_tg_link_desc: "لینک گروهت را با همه اعضای اتحادیه به اشتراک بگذار.",
      guild_btn_save: "ذخیره",
      guild_tg_invalid_prefix: "باید با https://t.me/… شروع شود.",
      guild_tg_saved: "✓ ذخیره شد!",
      guild_tg_cleared: "✓ پاک شد.",
      guild_tg_invalid_link: "لینک تلگرام نامعتبر است.",
      guild_could_not_save: "ذخیره نشد.",
      guild_applications_title: "درخواست‌ها",
      guild_no_applications: "درخواست در انتظاری نیست.",
      guild_btn_accept: "✓ پذیرفتن",
      guild_btn_reject: "✗ رد کردن",
      guild_pending_count: "{n} در انتظار",
      guild_warrior_accepted: "جنگاور پذیرفته شد!",
      guild_err_clan_full: "اتحادیه پر است.",
      guild_err_already_in_clan: "قبلاً در یک اتحادیه هستی.",
      guild_err_could_not_accept: "پذیرفته نشد.",
      guild_app_rejected: "درخواست رد شد.",
      guild_err_could_not_reject: "رد نشد. دوباره تلاش کن.",
      guild_upgrade_forge_name: "کوره‌ی جنگ",
      guild_upgrade_forge_desc: "+۵٪ زر در ساعت برای همه اعضا",
      guild_upgrade_banner_name: "پرچم نبرد",
      guild_upgrade_banner_desc: "+۱۰٪ تجربه‌ی قهرمان",
      guild_upgrade_vault_name: "خزانه‌ی شاهی",
      guild_upgrade_vault_desc: "سقف خزانه ×۲",
      guild_upgrade_siege_name: "منجنیق‌های محاصره",
      guild_upgrade_siege_desc: "+۱۵٪ در جنگ‌های اتحادیه",
      guild_required_suffix: "لازم",
      guild_btn_unlock: "باز کردن",
      guild_btn_locked: "قفل‌شده",
      guild_upgrades_title: "ارتقاهای اتحادیه",
      guild_coming_soon: "به زودی",
      guild_quest_chapter_title: "خوانندگان فصل",
      guild_quest_chapter_desc: "اعضای اتحادیه این هفته فصل‌ها را تمام می‌کنند",
      guild_quest_chapter_reward: "۵٬۰۰۰ ریال برای هرکس",
      guild_quest_recruit_title: "جنگاوران جذب‌شده",
      guild_quest_recruit_desc: "اتحادیه را با دعوت جنگاوران تازه بزرگ کن",
      guild_quest_recruit_reward: "۲٬۵۰۰ ریال برای هرکس",
      guild_quest_gem_title: "خراج جواهر",
      guild_quest_gem_desc: "اعضای اتحادیه از طریق قهرمانان جواهر کسب می‌کنند",
      guild_quest_gem_reward: "۱٬۰۰۰ ریال برای هرکس",
      guild_resets_sunday: "بازنشانی یکشنبه",
      guild_daily_soon: "ماموریت‌های روزانه و رویدادهای فصلی — به زودی.",
      guild_by_real_earned: "بر اساس ریال کسب‌شده",
      guild_wars_soon: "نبردهای زنده‌ی اتحادیه — به زودی.",
      guild_your_balance: "موجودی تو: {bal} ریال",
      guild_open_telegram: "برای کمک، از طریق تلگرام باز کن.",
      guild_min_contrib: "کمترین کمک: ۱۰۰ ریال.",
      guild_contributed: "✓ {amount} ریال به خزانه کمک شد!",
      guild_err_insufficient: "ریال کافی در موجودی‌ات نیست.",
      guild_err_not_in_clan: "تو در هیچ اتحادیه‌ای نیستی.",
      guild_err_minimum_100: "حداقل ۱۰۰ ریال است.",
      guild_err_failed_contribute: "کمک انجام نشد. دوباره تلاش کن.",
      enter_event: "ورود",
      ...
      inv_active_boosts: "تقویت‌های فعال",
      inv_shop: "فروشگاه",
      inv_autoclicker_name: "کلیک‌گر خودکار",
      inv_autoclicker_desc: "تمام فصل به‌صورت خودکار ضربه می‌زند · انرژی را مثل ضربه‌های واقعی مصرف می‌کند",
      inv_autoclicker_active: "تمام فصل برای شما می‌زند · انرژی را مثل ضربه‌های واقعی مصرف می‌کند",
      inv_autoclicker_one_time: "خرید یک‌باره",
      inv_autoclicker_season_item: "آیتم فصل — تا پایان فصل ۲ فعال است",
      inv_autoclicker_owned: "در دسترس",
      inv_autoclicker_owned_btn: "خریداری شده",
      inv_autoclicker_buy: "فعال‌سازی · ۵۰ هزار",
      inv_autoclicker_toast: "🤖 کلیک‌گر خودکار برای تمام فصل فعال شد!",
      ac_badge_label: "کلیک‌گر خودکار روشن",
      ...
      energy_upgrade_lbl: "ارتقای انرژی",
      energy_upgrade_max: "بالاترین سطح",
      energy_upgrade_btn: "ارتقا",
      energy_level_lbl: "سطح انرژی",
      profile: "پروفایل",
      ...
      dynasty_locked_toast: "این شخصیت هنوز باز نشده است",
      dynasty_locked_ch_toast: "فصل {n} را باز کنید تا این شخصیت را ملاقات کنید",
      ...
      offering_3_cost: "۳ فرّ",
      offering_already: "این خاطره پیش از این به آتش نذر شده است.",
      offering_insufficient: "هنوز به اندازه کافی برای این نذر ندارید.",
      offering_need_energy: "برای این نذر به ۵۰۰ ⚡ انرژی نیاز دارید.",
      offering_need_taps: "برای این نذر باید امروز ۱٬۰۰۰ ضربه زده باشید.",
      offering_need_farr: "برای این نذر به ۳ ✦ فرّ نیاز دارید. فصل‌ها را تکمیل کنید تا فرّ کسب کنید.",
      offering_need_real: "برای این نذر به ۱۰۰ REAL نیاز دارید.",
      ...
      /* ── Beta notice ── */
      beta_notice_title:  "آزمایش بتا در جریان است",
      beta_notice_body:   "شما در حال استفاده از <strong>نسخه بتای فصل دوم</strong> REAL Shahnameh هستید. همه چیزی که می‌بینید — امتیاز، موجودی، قهرمانان و پیشرفت — صرفاً برای اهداف آزمایشی است.",
      beta_notice_warn:   "⚠️ تمام داده‌ها هنگام افتتاح رسمی فصل دوم <strong>به صفر بازنشانی</strong> خواهند شد.",
      beta_notice_thanks: "از اینکه بخشی از تیم آزمایش ما هستید سپاسگزاریم! بازخورد شما راه‌اندازی واقعی را بهتر می‌کند. 🙏",
      beta_notice_btn:    "فهمیدم — بیایید آزمایش کنیم!",

      /* ── نام فصل‌های داستانی (۴۹ فصل) ── */
      story_ch_1:  "اولین شاه",
      story_ch_2:  "آتش‌افروز",
      story_ch_3:  "طهمورس",
      story_ch_4:  "عصر طلایی",
      story_ch_5:  "ضحاک",
      story_ch_6:  "فریدون",
      story_ch_7:  "منوچهر",
      story_ch_8:  "نوذر",
      story_ch_9:  "زال",
      story_ch_10: "رودابه",
      story_ch_11: "تولد رستم",
      story_ch_12: "رستم",
      story_ch_13: "رستم و سهراب",
      story_ch_14: "سیمرغ",
      story_ch_15: "اکوان دیو",
      story_ch_16: "هفت‌خان اسفندیار",
      story_ch_17: "سیاوش",
      story_ch_18: "کی‌کاووس",
      story_ch_19: "کی‌خسرو",
      story_ch_20: "بیژن و منیژه",
      story_ch_21: "جنگ بزرگ با توران",
      story_ch_22: "لهراسپ",
      story_ch_23: "گشتاسپ",
      story_ch_24: "اسفندیار",
      story_ch_25: "نبرد در دماوند",
      story_ch_26: "پایان رستم",
      story_ch_27: "یاد بر شمشیر",
      story_ch_28: "بهمن",
      story_ch_29: "همای",
      story_ch_30: "داراب",
      story_ch_31: "دارا",
      story_ch_32: "اسکندر",
      story_ch_33: "سوگ پارس",
      story_ch_34: "عصر اشکانیان",
      story_ch_35: "اردوان",
      story_ch_36: "اردشیر",
      story_ch_37: "شاپور",
      story_ch_38: "یزدگرد گناهکار",
      story_ch_39: "بهرام گور",
      story_ch_40: "انوشیروان",
      story_ch_41: "نوشزاد",
      story_ch_42: "هرمز",
      story_ch_43: "بهرام چوبین",
      story_ch_44: "خسرو پرویز",
      story_ch_45: "شیرین",
      story_ch_46: "یزدگرد سوم",
      story_ch_47: "فتح اعراب",
      story_ch_48: "پایان دوران",
      story_ch_49: "میراث فردوسی",
