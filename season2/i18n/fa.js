...
(function () {
  ...
  L.fa = {
      ...
      inv_autoclicker_desc: "یک ساعت به‌صورت خودکار ضربه می‌زند · انرژی را مثل ضربه‌های واقعی مصرف می‌کند",
      inv_autoclicker_active: "دارد برای شما می‌زند — وقتی انرژی تمام شد متوقف می‌شود",
      inv_autoclicker_per_hour: "/ ۱ ساعت",
      inv_autoclicker_stackable: "قابل افزودن",
      inv_autoclicker_buy: "فعال‌سازی · ۵۰ هزار",
      inv_autoclicker_extend: "+۱ ساعت",
      inv_autoclicker_toast: "🤖 کلیک‌گر خودکار فعال شد!",
