  ...
  const applyLocale = () => {
    ...
    const titleByLang = {
      fa: {
        ...
        "hakim.html":          "ریل شاهنامه — حکیم",
        "regions.html":        "ریل شاهنامه — مناطق پارس",
        "historical-sites.html":"ریل شاهنامه — مکان‌های تاریخی",
      ...
      tg: {
        ...
        "hakim.html":            "REAL Шоҳнома — Ҳаким",
        "regions.html":          "REAL Шоҳнома — Вилоятҳои Порс",
        "historical-sites.html": "REAL Шоҳнома — Ҷойҳои таърихӣ",
