...
(() => {
  ...
  COLLECTION.push(
    ...
    },
    {
      ...
      name_ru: "Хосров Парвиз — Завоеватель",
      role_ru: "Хосров II · Последний великий Сасанид · Завоеватель Иерусалима · Возлюбленный Ширин",
      lore_ru: "Он завоевал больше территории, чем любой персидский царь со времён Дария I. Он захватил Иерусалим и привёз Истинный Крест в Ктесифон. Затем вернулся Ираклий. Затем его убил собственный сын. Затем пришёл ислам. За тридцать лет величайшая империя Азии превратилась в руины.",
      biography_ru: "Хосров II Парвиз начал блестяще — отвоевав большую часть византийского востока, захватив Египет и Сирию, дойдя до стен Константинополя. Он построил знаменитый тронный зал Тахт-е Такдис и владел легендарным конём Шабдиз. Но византийский император Ираклий начал разрушительную контркампанию, проникнувшую глубоко в Персию. Когда Хосров отказался заключить мир, его сын Широе организовал дворцовый переворот, убил его и заключил переговоры с Ираклием. Империя, истощённая десятилетиями войны, теперь была беззащитна перед арабскими армиями, что прибыли десятилетие позже.",
    },
    {
      ...
      name_ru: "Ширин — Царица любви",
      role_ru: "Армянская принцесса · Царица Персии · Женщина, что любили и потеряли два великих царя",
      lore_ru: "Хосров влюбился в её портрет, прежде чем встретил её. Она отказывала ему, пока он не стал достоин. Каменотёс Фархад вырубил для неё гору, и Хосров приказал сбросить его с неё. Она никогда не простила его. Она убила себя на его могиле.",
      biography_ru: "Ширин — великая любовь персидской литературы — равные части реальной исторической фигуры (христианской царицы, обладавшей значительной властью при дворе Сасанидов) и литературного архетипа. В более позднем изложении Незами она становится полным символом возлюбленной, что испытывает и отказывает, пока не убедится в достоинстве. В версии Фирдоуси она царица, что переживает своего царя: когда Хосров Парвиз был убит их сыном Широе, Ширин пошла взглянуть на тело, говорила с ним, а затем заколола себя. Никто не отнял у неё политическую власть силой. Она отказалась уступить её при жизни и отказалась жить без неё.",
    },
    {
      ...
      name_ru: "Пурандохт — Царица-воительница",
      role_ru: "Дочь Хосрова Парвиза · Первая женщина, правившая Сасанидской Персией",
      lore_ru: "После убийства её отца империя Сасанидов сменила двенадцать царей за четыре года. Она была одной из двух женщин, что правили в этом хаосе. Она вела переговоры с Ираклием и вернула Истинный Крест. Она удерживала вместе то, что осталось.",
      biography_ru: "Пурандохт правила недолго — вероятно, в 629-630 годах н.э. — во время краха системы Сасанидов. Она была дочерью Хосрова Парвиза и сестрой Широе, что убил их отца. Её правление отмечено одним крупным дипломатическим достижением: возвращением Истинного Креста византийцам, что завершило 26-летнюю войну, истощившую обе империи. Арабские армии прибудут в течение десятилетия. Пурандохт представляет последнюю осмысленную попытку стабилизировать Персию перед окончательным крахом. Её сестра Азармидохт правила недолго после неё.",
    },
    ...
    /* ═══ FALL OF PERSIA & FERDOWSI — Ch 45–50 ════════════════════════════ */
    {
      ...
      name_ru: "Йездигерд III — Последний царь",
      role_ru: "Последний император Сасанидов · Бежал через всю Персию · Умер в хижине мельника",
      lore_ru: "Он бежал шестнадцать лет. От Ктесифона до Исфахана до Мерва, всегда на шаг впереди арабских армий, всегда надеясь на финальную битву, что так и не наступила. Он был убит мельником за монеты на его поясе.",
      biography_ru: "Йездигерд III пришёл к трону ребёнком во время хаоса, последовавшего за убийством Хосрова Парвиза. Он был внуком Хосрова Парвиза и последним императором Сасанидов. Арабские армии пересекли границу в 633 году н.э. Битвы при Кадисии и Нехавенде окончательно разбили армию Сасанидов. Йездигерд бежал на восток, обращаясь к туркам и китайцам за помощью, что так и не пришла. Он умер в 651 году н.э. в Мерве, убитый за свои пожитки. 400-летняя империя Сасанидов закончилась. Персидский мир продолжит существовать под арабским правлением и позже возродится в новых формах — но огнепоклонническая империя Ардешира и Ануширвана была погашена.",
    },
    {
      ...
      name_ru: "Рустам Фаррохзад — Последняя стена",
      role_ru: "Сасанидский командующий при Кадисии · Погиб, защищая Персию · Последний генерал",
      lore_ru: "Он написал письмо своему брату, предупреждая, что ислам изменит мир, и что он не ожидает выжить в битве. Он был прав в обоих случаях. При Кадисии, на третий день, он был убит. Последняя армия Ирана рассыпалась позади него.",
      biography_ru: "Рустам Фаррохзад был спахбедом (верховным командующим) армии Сасанидов в битве при Кадисии в 636 году н.э. — решающей битве арабского завоевания Персии. Он командовал армией с боевыми слонами против меньшей, но более мотивированной арабской силы под командованием Саада ибн Абу Ваккаса. Битва длилась три-четыре дня. В последний день Рустам Фаррохзад был убит — по одним сведениям, Хилялем ибн Уллафой, по другим — самим Саадом. Его смерть сломала линию Сасанидов. Имя Рустам — то же, что у великого героя Шахнаме — делает его смерть похожей на конец самой Шахнаме.",
    },
    {
      ...
      name_ru: "Пируз — Неугасимое сопротивление",
      role_ru: "Сын Йездигерда III · Вёл персидское сопротивление · Пламя, что не желало гаснуть",
      lore_ru: "После смерти отца Пируз увёл сопротивление на восток, в Хорасан, а затем в Китай. Династия Тан приняла его. Пламя легитимности Сасанидов горело в изгнании десятилетиями, прежде чем наконец погасло. Но огонь трудно убить.",
      biography_ru: "Пируз (Пероз в некоторых транслитерациях) был сыном Йездигерда III, что бежал на восток после убийства отца. Он достиг Хорасана и попытался организовать сопротивление с тюркскими союзниками. Когда это не удалось, он отправился к двору Тан в Китае, где император Гаоцзун дал ему должность и титул. Пируз представлял продолжение легитимности Сасанидов в изгнании. Его сын Нарсие также жил в Китае. Линия в итоге исчезла в китайской истории. Шахнаме рассказывает историю скорби Парса — горя самой земли о том, что было утрачено.",
    },
    {
      ...
      name_ru: "Фирдоуси — Поэма против забвения",
      role_ru: "Абу-ль-Касим Фирдоуси · Поэт Туса · 35 лет за перьем",
      lore_ru: "Ему было за шестьдесят, когда он закончил её. Он десятилетиями наблюдал, как персидский мир меняется вокруг него. Он написал Шахнаме не потому, что кто-то его просил, а потому, что язык нуждался в защите, и он был тем, кто мог это сделать.",
      biography_ru: "Абу-ль-Касим Фирдоуси Туси (940-1020 н.э.) провёл примерно 35 лет, сочиняя Шахнаме. Он был землевладельцем в деревне Табаран, близ Туса в Хорасане, и использовал собственные средства, чтобы поддерживать сочинение поэмы, когда не было надёжного покровительства. Шахнаме не была заказана султаном Махмудом — Фирдоуси работал над ней десятилетиями, прежде чем двор султана заинтересовался. Поэма сохраняет примерно 1000 лет персидской мифологической и исторической традиции в примерно 60 000 двустишиях. Без неё доисламская история Ирана существовала бы лишь в обрывках.",
    },
    {
      ...
      name_ru: "Фирдоуси — Поэма завершена",
      role_ru: "Фирдоуси в момент завершения · 60 000 двустиший написано · Язык спасён",
      lore_ru: "Около 1010 года н.э., в Тусе. Было написано последнее двустишие. Фирдоуси отложил перо. Он совершил то, что никогда не было сделано прежде. У персидского языка теперь была броня, что никакое завоевание не могло снять.",
      biography_ru: "Когда Фирдоуси завершил Шахнаме около 1010 года н.э., ему было примерно 70 лет. Он пережил своего сына, видел, как падает его земельный доход, и наблюдал, как культурный ландшафт Хорасана всё больше арабизируется. Шахнаме была ответом, на написание которого он потратил всю жизнь. Приём султана Махмуда был, по преданию, холодным — серебряные монеты вместо золотых, намеренное унижение. Говорят, что Фирдоуси раздал серебро банщику и бежал, а затем написал разрушительную сатиру на султана. Он умер около 1020 года н.э. в Тусе, не увидев своего оправдания. В течение столетия Шахнаме была признана величайшим произведением персидской литературы.",
    },
    {
      ...
      name_ru: "Фарр Ирана — Вечный",
      role_ru: "Божественная слава Ирана · Фарр, что переживал каждое завоевание",
      lore_ru: "Он покинул Джамшида, когда тот возгордился. Он благословил Фаридуна. Он избрал Кай Хосрова и ушёл с ним в горы. Он жил в языке поэмы. Каждая прочитанная вами глава — его фрагмент.",
      biography_ru: "Фарр (Хварена на авестийском) — божественная царская слава Шахнаме — светящаяся сила, что дарует легитимность царям, обеспечивает их победы и покидает их, когда они предают своё предназначение. Его не дают. Его не наследуют. Он выбирает. Когда царь становится высокомерным или несправедливым, Фарр уходит, и он падает. Весь сюжет Шахнаме — история о том, куда уходит Фарр и почему. Фирдоуси направил его в поэму. Теперь поэма несёт его. Эта карта вручается тем, кто завершает путь.",
    }
